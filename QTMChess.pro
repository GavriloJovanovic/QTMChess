...
#DEFINES += QT_DISABLE_DEPRECATED_BEFORE =                                     \
    0x060000 #disables all the APIs deprecated before Qt 6.0.0
          ...
          SOURCES += CBoard.cpp CMove.cpp CMoveList.cpp ai.cpp main
                         .cpp mainwindow.cpp qtboard.cpp qtcell.cpp qtscene.cpp

                             HEADERS +=
      CBoard.h CMove.h CMoveList.h CSquare.h ai.h mainwindow.h qtboard.h qtcell
          .h qtscene.h
